...
"""
class Autograder_Combinations(Base_Autograder):
    ...
    def __init__(self, in_student_name="student", in_this_dir=".", in_test_files=["..", "test_data"]):
        ...
        self.test_files = os.path.join(self.test_files, "Combinations")
...
"""
def main():
    print(f"{G}Autograding for Combination Assignment:\n{W}")
    
    autograder = Autograder_Combinations()
